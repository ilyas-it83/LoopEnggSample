...
| CI Sweeper | Failed CI, manual | L2 isolated report |
| Daily Triage | Weekday schedule, manual | L1 report-only |
| Dependency Sweeper | Every six hours, manual | L2 isolated dependency reports |
...
human gates, and no automatic merge or production write access.
